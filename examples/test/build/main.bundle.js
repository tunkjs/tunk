...
function extend(name, target) {
    ...
    (0, _assign2.default)(protos, mixins, {
        getState: function getState(otherModelName) {
            if (!otherModelName) return clone(store[name]);else return clone(store[otherModelName]);
        }
    });

    (0, _defineProperties2.default)(protos, {
        'state': {
            get: function get() {
    ...
    var properties = (0, _getOwnPropertyNames2.default)(target.prototype);

    for (var i = 0, l = properties.length, x = properties[i]; i < l; i++, x = properties[i]) {

        if (protos[x] && protos[x]._isAction_) protos[x] = function (modelName, actionName, originAction) {
...
baflow.dispatch = function (modelName, options) {
    if (modelName && modelName.constructor === String) storeState(options, modelName, 'Vue.flow');else throw 'the first argument should be a model name the second shuould be a plain object';
};
...
baflow.mixin = function (obj) {
    (0, _assign2.default)(mixins, obj);
};

baflow.__ = {
    connectState: function connectState(targetObject, stateOptions) {
        var initailState = {};
        if (stateOptions) {
            for (var x in stateOptions) {
                if (stateOptions.hasOwnProperty(x)) {
    ...
    connectActions: function connectActions(target, actionOptions) {
        if (actionOptions) {
            var action;
            for (var x in actionOptions) {
                if (actionOptions.hasOwnProperty(x)) {
    ...
    connectDispatch: function connectDispatch(target, name) {
    ...
    disconnect: function disconnect(target, stateOptions, actionOptions) {
        if (stateOptions) {
            var statePath, tmp;
            for (var x in stateOptions) {
                if (stateOptions.hasOwnProperty(x)) {
    ...
    addStateUpdatedListener: function addStateUpdatedListener(handler) {
...
function clone(obj) {
    if ((typeof obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(obj)) === 'object') return baflow.config.cloneMode === 'deep' ? JSON.parse((0, _stringify2.default)(obj)) : obj.constructor === Array ? obj.slice() : (0, _assign2.default)({}, obj);else return obj;
}
...
var baflow = __webpack_require__(14);

baflow.install = function (Vue) {

    baflow.__.addStateUpdatedListener(function (targetObject, stateName, newValue, action) {
        if (targetObject.$options.beforeFlowIn) targetObject.$options.beforeFlowIn.call(targetObject, stateName, newValue, action);
    ...
    Vue.mixin({
        ...
        init: function init() {
            if (this.$options.state) {
                ...
                for (var x in initailState) {
                    if (initailState.hasOwnProperty(x)) {
...
(function () {
    ...
    function cookie(key, json) {
        if (arguments.length > 1 && json !== true) return set.apply(cookie, arguments);else return get.apply(cookie, arguments);
    }
    ...
    cookie.remove = function (key, attributes) {
        set(key, '', (0, _assign2.default)({}, attributes, {
            expires: -1
        }));
    };
...
;(function () {
    ...
    function request(options) {
        var settings = (0, _assign2.default)({}, options || {}),
            urlAnchor,
            hashIndex;
        for (key in request.ajaxSettings) {
            if (settings[key] === undefined) settings[key] = request.ajaxSettings[key];
    ...
    function ajaxBeforeSend(xhr, settings) {
        if (settings.beforeSend(xhr, settings) === false) return false;
    }
    ...
    function ajaxJSONP(options) {
        ...
        var promise = new _promise2.default(function (resolve) {
            ...
            var _callbackName = options.jsonpCallback,
                callbackName = (typeof _callbackName === 'function' ? _callbackName() : _callbackName) || 'request' + jsonpID++,
    ...
    function serializeData(options) {
        if (options.processData && options.data && typeof options.data != "string") options.data = param(options.data, options.traditional);
    ...
    function parseArguments() {
        ...
        for (var i = 0, l = arguments.length; i < l; i++) {
            switch ((0, _typeof3.default)(arguments[i])) {
                case 'string':
                    if (url) dataType = arguments[i];else url = arguments[i];
                    break;
                case 'object':
                    data = arguments[i];
                    break;
                case 'function':
                    if (success === empty) success = arguments[i];else error = arguments[i];
                    break;
                case 'boolean':
                    silent = arguments[i];
                    break;
    ...
    function serialize(params, obj, traditional, scope) {
        var type,
            array = (typeof obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(obj)) === 'object' && obj.constructor === Array,
            hash = (typeof obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(obj)) === 'object' && obj.constructor === Object;
        for (var key in obj) {
            type = (0, _typeof3.default)(obj[x]);
            ...
            else if (type == "array" || !traditional && type == "object") serialize(params, obj[x], traditional, key);else params.add(key, obj[x]);
        }
    }
...
module.exports = Vue;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(39), __webpack_require__(64)))
...
var compons = __webpack_require__(80);
...
var _class, _desc, _value, _class2; // <template>
...
var _baflow = __webpack_require__(14);
...
var options = (0, _baflow.extend)(_class = (_class2 = function () {
	function options() {
	...
	(0, _createClass3.default)(options, [{
		key: 'test_dispatched',
		value: function test_dispatched() {
			return { t: 'dispatched' };
		}
	}, {
		key: 'test_action_multi_options',
		value: function test_action_multi_options(a, b) {
			this.dispatch('options.test_dispatch_multi_options', a, b);
			return { t: a + '+' + b };
		}
	}, {
		key: 'test_dispatch_multi_options',
		value: function test_dispatch_multi_options(a, b) {

			return { t: a + '-' + b };
		}
	}, {
		key: 'test_dispatch',
		value: function test_dispatch() {
			this.dispatch('test_dispatched');
		}
	}, {
		key: 'test_action',
		value: function test_action() {
			this.dispatch({ t: 'action' });
		}
	}]);
	return options;
}(), (_applyDecoratedDescriptor(_class2.prototype, 'test_dispatched', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_dispatched'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_action_multi_options', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_action_multi_options'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_dispatch_multi_options', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_dispatch_multi_options'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_dispatch', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_dispatch'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_action', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_action'), _class2.prototype)), _class2)) || _class;
...
exports.default = {
	...
	components: {
		test: __webpack_require__(65)
	},

	beforeFlowIn: function beforeFlowIn(stateName, value, action) {
	...
	ready: function ready() {
		...
		setTimeout(function () {
			_this.dispatch('options.test_action');
		}, 100);

		setTimeout(function () {
			_this.dispatch('options.test_action_multi_options', '1', '2');
		}, 400);
	}
};
// </script>
...
var request = (0, _baflow.extend)(_class = (_class2 = function () {
	function request() {
	...
	(0, _createClass3.default)(request, [{
		key: 'test_jsonp',
		value: function test_jsonp() {
			var self = this;
			var jsonp = this.jsonp('http://search.lefeng.com/ajax/getHotKeys', function (v) {
				if (v.data) self.dispatch({ t: 'jsonp' });
			});
		}
	}, {
		key: 'test_jsonp_promise',
		value: function () {
				...
				return _regenerator2.default.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.next = 2;
								return this.jsonp('http://search.lefeng.com/ajax/getHotKeys', function (v) {});
							...
							case 2:
								...
								return _context.abrupt('return', { t: 'jsonp_promise' });
			...
			function test_jsonp_promise() {
				return _ref.apply(this, arguments);
			}

			return test_jsonp_promise;
		}()
	}, {
		key: 'test_jsonp_abort',
		value: function test_jsonp_abort() {
			var self = this;
		...
		key: 'test_json',
		value: function test_json() {
			var self = this;
			var json = this.getJson('http://search.lefeng.com/ajax/getHotKeys', function (v) {
				if (v.data) self.dispatch({ t: 'json' });
			});
		}
	}, {
		key: 'test_json_promise',
		value: function () {
				...
				return _regenerator2.default.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								_context2.next = 2;
								return this.getJson('http://search.lefeng.com/ajax/getHotKeys', function (v) {});
							...
							case 2:
								...
								return _context2.abrupt('return', { t: 'json_promise' });
			...
			function test_json_promise() {
				return _ref2.apply(this, arguments);
			}

			return test_json_promise;
		}()
	}, {
		key: 'test_json_abort',
		value: function test_json_abort() {
			var self = this;
		...
		key: 'test_$request_model',
		value: function test_$request_model() {
			var self = this;
	...
	return request;
}(), (_applyDecoratedDescriptor(_class2.prototype, 'test_jsonp', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_jsonp'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_jsonp_promise', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_jsonp_promise'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_jsonp_abort', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_jsonp_abort'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_json', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_json'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_json_promise', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_json_promise'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_json_abort', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_json_abort'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'test_$request_model', [_baflow.action], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'test_$request_model'), _class2.prototype)), _class2)) || _class;
...
exports.default = {
	options: __webpack_require__(154),
	//promise:require('./promise.vue'),
	request: __webpack_require__(155)
};
module.exports = exports['default'];
...
$export($export.S + $export.F * !__webpack_require__(3), 'Object', {defineProperties: __webpack_require__(52)});
...
module.exports = "\n<section v-for=\"comp in compons\" _v-4e2b9602=\"\">\n  <component :is=\"comp\" _v-4e2b9602=\"\"></component>\n</section>\n";
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] tests/destroy.vue: named exports in *.vue files are ignored.")}
...
if (__vue_script__ &&
    __vue_script__.__esModule &&
    Object.keys(__vue_script__).length > 1) {
  console.warn("[vue-loader] tests/request.vue: named exports in *.vue files are ignored.")}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-rewriter.js?id=_v-4e2b9602&scoped=true!./node_modules/vue-loader/lib/selector.js?type=style&index=0!./App.vue", function() {
			var newContent = require("!!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-rewriter.js?id=_v-4e2b9602&scoped=true!./node_modules/vue-loader/lib/selector.js?type=style&index=0!./App.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _baflow2 = _interopRequireDefault(_baflow);

__webpack_require__(67);

var _vueFlowPromiseMiddleware = __webpack_require__(70);

var _vueFlowPromiseMiddleware2 = _interopRequireDefault(_vueFlowPromiseMiddleware);

var _vueFlowFunctionMiddleware = __webpack_require__(69);

var _vueFlowFunctionMiddleware2 = _interopRequireDefault(_vueFlowFunctionMiddleware);

var _vueFlowActionMiddleware = __webpack_require__(68);

var _vueFlowActionMiddleware2 = _interopRequireDefault(_vueFlowActionMiddleware);

var _vueFlowRequestMixin = __webpack_require__(72);

var _vueFlowRequestMixin2 = _interopRequireDefault(_vueFlowRequestMixin);

var _vueFlowCookieMixin = __webpack_require__(71);

var _vueFlowCookieMixin2 = _interopRequireDefault(_vueFlowCookieMixin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(_baflow2.default);

_baflow2.default.addMiddleware([_vueFlowActionMiddleware2.default, _vueFlowFunctionMiddleware2.default, _vueFlowPromiseMiddleware2.default]);
_baflow2.default.mixin((0, _vueFlowRequestMixin2.default)());
_baflow2.default.mixin(_vueFlowCookieMixin2.default);

new _vue2.default({
    el: 'body',
    components: {
        App: __webpack_require__(73)
    }
});
